					...
					<div class="col-12">
						<div class="card">
							<div class="card-body">
								...
								<div id="select-form">
									<select class="form-select" id="selectCarMenu"
										name="selectCarMenu">
										<option value="car">차량등록</option>
										<option value="notice">공지등록</option>
									</select>
								</div>
										...
										<div class="col-12 col-sm-6">
											<div class="card">
												<div class="card-content">
													...
													<!-- 차량관리 -->
													<div class="card-body" id="carMenu">
																...
																<c:choose>
																	<c:when test="${ pi.currentPage ne 1 }">
																		<li class="page-item"><a class="page-link"
																			href="carSetting.do?currentPage=${ pi.currentPage-1 }"><span
																				aria-hidden="true"><i
																	...
																	<c:choose>
																		<c:when test="${ pi.currentPage ne p }">
																			<li class="page-item" id="nowPage"><a
																				class="page-link"
																				href="carSetting.do?currentPage=${ p }">${ p }</a></li>
																		</c:when>
																		<c:otherwise>
																...
																<div class="modal-dialog">
																	<div class="modal-content">
																		...
																		<div class="modal-footer">
																			<button type="button" class="btn btn-primary"
																				id="addCar" data-dismiss="modal">등록</button>
																		</div>
																	</div>
																</div>
															</div>
