...
<body>
	...
	<script>
		...
		$(function(){
			...
			if($("#CompleteListView tbody tr").children().eq(1).text() == 10){
				$("#foNo").text("휴가신청서");
			...
			console.log($("#CompleteListView tbody tr").children().eq(0).text())
			console.log($("#CompleteListView tbody tr").children().eq(1).text())
	    });
